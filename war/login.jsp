		...
		<div class="container-fluid">
			<div class="lock-container">
				...
				<div class="panel panel-default text-center">
					<a href="index.html"><img src="images/guy-5.jpg" class="img-circle"></a>
					<div class="panel-body">
						...
						<p>El ingreso al sistema se realizara por medio de su cuenta
							en Google.</p>
						<a href="${login_link}" class="btn btn-primary">Ingresar <i
